...
import { Car, Settings, Shield, CheckCircle, Search } from "lucide-react";
...
const Vehicles = () => {
  ...
  return (
    <main className="w-full min-h-screen pt-10 bg-[#FDFDFD]" style={{ fontFamily: "'Poppins', sans-serif" }}>
      ...
      {/* 3. Vehicle Grid Section — 4 cols desktop, 2 tablet, 1 mobile */}
              ...
              >
                ...
                <div className="relative h-52 overflow-hidden">
                  ...
                  <div className="absolute top-3.5 right-3.5 w-[4.2rem] h-[4.2rem] rounded-full bg-white/50 backdrop-blur-lg border border-white/30 shadow-lg flex flex-col items-center justify-center z-10">
                    ...
                    <span className="text-[11px] font-bold text-gray-800 leading-tight mt-0.5">{vehicle.pricePerKm}/KM</span>
                  </div>
                </div>
                ...
                <div className="bg-white px-5 py-7 text-center">
                  ...
                  <p className="text-[11px] text-gray-400 mb-4 font-medium">
                    {vehicle.type} · {vehicle.fuelType} · {vehicle.seatingCapacity} seats
                  </p>
                  <Link

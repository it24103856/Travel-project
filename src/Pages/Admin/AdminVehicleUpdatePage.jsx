  ...
  if (loading) return (
    <div className="min-h-screen flex items-center justify-center bg-[#FDFDFD]">
      <div className="flex flex-col items-center gap-4">
        <FiLoader className="animate-spin text-[#6366F1] text-4xl" />
    ...
    <div className="min-h-screen bg-[#FDFDFD] py-12 px-6 font-[Inter]">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <h1 className="text-2xl font-[Playfair_Display] font-bold text-gray-900">Edit <span className="text-[#6366F1]">Vehicle Asset</span></h1>
        </div>
        ...
        <form onSubmit={handleUpdate} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 space-y-8">
              ...
              {/* Basic Details */}
              <section>
                <h3 className="text-sm font-black uppercase tracking-[0.2em] text-[#6366F1] mb-6 flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    ...
                    <select className="w-full px-5 py-4 bg-gray-50 border border-gray-100 rounded-2xl outline-none focus:border-[#6366F1] transition-all"
                  ...
                  <div className="space-y-2">
                    ...
                    <input required className="w-full px-5 py-4 bg-gray-50 border border-gray-100 rounded-2xl outline-none focus:border-[#6366F1] transition-all font-mono"
                      value={formData.registrationNumber} onChange={(e) => setFormData({...formData, registrationNumber: e.target.value})} />
                  </div>
                  <input required placeholder="Make (e.g. Toyota)" className="w-full px-5 py-4 bg-gray-50 border border-gray-100 rounded-2xl outline-none focus:border-[#6366F1] transition-all"
                    value={formData.make} onChange={(e) => setFormData({...formData, make: e.target.value})} />
                  <input required placeholder="Model (e.g. Axio)" className="w-full px-5 py-4 bg-gray-50 border border-gray-100 rounded-2xl outline-none focus:border-[#6366F1] transition-all"
              ...
              <section className="pt-8 border-t border-gray-50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="flex items-center gap-3 bg-[#6366F1]/5 p-4 rounded-2xl border border-[#6366F1]/10">
                    <DollarSign size={20} className="text-[#6366F1]" />
                    <input type="number" placeholder="Price/KM" className="bg-transparent outline-none w-full font-bold text-[#6366F1]" min="0"
              ...
              <button type="submit" disabled={updating || uploading} className="w-full py-5 bg-[#6366F1] text-white rounded-full font-black uppercase tracking-widest shadow-xl shadow-[#6366F1]/20 hover:bg-[#4F46E5] transition-all disabled:bg-gray-300">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                ...
                <label className="cursor-pointer border-2 border-dashed border-gray-100 rounded-2xl flex flex-col items-center justify-center aspect-square hover:bg-[#6366F1]/5 hover:border-[#6366F1]/30 transition-all">
                  <input type="file" hidden multiple onChange={handleImageChange} disabled={uploading} />
                  {uploading ? <FiLoader className="animate-spin text-[#6366F1]" /> : <FiUploadCloud className="text-gray-300 text-xl" />}

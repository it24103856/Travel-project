...
export default function AdminVehiclePage() {
  ...
  if (loading) return <div className="text-center mt-20 text-[#00AEEF] animate-pulse font-[Inter]">Loading Fleet Assets...</div>;
  ...
  return (
    <div className="relative min-h-screen p-6 bg-[#FDFDFD] font-[Inter]">
      ...
      <div className="mb-8 flex justify-between items-end">
        ...
        <Link to="/admin/vehicles/create" className="bg-[#00AEEF] text-white px-6 py-3 rounded-2xl font-bold flex items-center gap-2 hover:bg-[#0095cc] transition-all shadow-lg shadow-[#00AEEF]/20 uppercase tracking-widest text-xs">
      ...
      <div className="bg-white rounded-3xl shadow-sm hover:shadow-xl overflow-hidden border border-gray-100 transition-all duration-500">
        <table className="w-full text-left border-collapse">
          ...
          <tbody>
            {vehicles.map((v) => (
              <tr key={v._id} className="border-b border-gray-50 hover:bg-[#00AEEF]/5 transition-all duration-500">
                <td className="p-4">
                ...
                <td className="p-4">
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px] text-[#00AEEF] font-bold uppercase tracking-tighter">{v.type}</span>
                  </div>
                </td>
                ...
                <td className="p-4">
                  <div className="flex justify-center gap-2">
                    <button onClick={() => navigate(`/admin/vehicles/update/${v._id}`)} className="p-2 bg-[#00AEEF]/10 text-[#00AEEF] rounded-xl hover:bg-[#00AEEF] hover:text-white transition-all">
                      <Pencil size={18} />
                    </button>
